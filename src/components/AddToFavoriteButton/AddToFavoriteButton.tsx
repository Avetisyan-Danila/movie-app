import styles from './AddToFavoriteButton.module.css';
import { AddToFavoriteButtonProps } from './AddToFavoriteButton.props.ts';
...
export const AddToFavoriteButton = ({
  ...
  return (
    <button
      className={cn(styles['add-to-favorite-button'], className, {
